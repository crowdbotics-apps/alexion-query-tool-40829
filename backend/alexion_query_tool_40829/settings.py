"""
Django settings for alexion_query_tool_40829 project.
...
ROOT_URLCONF = 'alexion_query_tool_40829.urls'
...
WSGI_APPLICATION = 'alexion_query_tool_40829.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "alexion_query_tool_40829 API",
    "DESCRIPTION": "API documentation for alexion_query_tool_40829 App",
    "VERSION": "v1",
}
